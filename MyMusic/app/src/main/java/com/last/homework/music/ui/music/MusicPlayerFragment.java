...
import com.last.homework.music.data.source.PreferenceManager;
import com.last.homework.music.event.PlayListNowEvent;
import com.last.homework.music.event.PlaySongEvent;
import com.last.homework.music.player.IPlayback;
...
import com.last.homework.music.ui.lyric.LyricView;
import com.last.homework.music.ui.widget.ShadowImageView;
import com.last.homework.music.utils.AlbumUtils;
...
public class MusicPlayerFragment extends BaseFragment implements MusicPlayerContract.View, IPlayback.Callback {
    ...
    private Runnable mProgressCallback = new Runnable() {
        ...
        public void run() {
            ...
            if (mPlayer.isPlaying()) {
                ...
                lyricView.SelectIndex(mPlayer.getProgress());
    ...
    public void onPlayToggleAction(View view) {
        ...
        if (mPlayer.isPlaying()) {
            ...
            mPlayer.play();
            lyricView.setOffsetY(220 - lyricView.SelectIndex(mPlayer.getProgress())
                    * (lyricView.getSIZEWORD() + INTERVAL-1));
        }
    }
    ...
    public void onSongUpdated(@Nullable Song song) {
        ...
        String lrc = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "Music" + File.separator + song.getDisplayName() + ".lrc";
        LyricView.read(lrc);
